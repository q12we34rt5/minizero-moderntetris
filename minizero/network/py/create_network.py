...
from .placement_mlp_network import PlacementMLPNetwork
    ...
    if network_type_name == "alphazero":
        ...
        if backbone in ("mlp_flat", "mlp_conv"):
            network = PlacementMLPNetwork(
                ...
                board_encoder="flat" if backbone == "mlp_flat" else "conv",
                hidden_ratio=cfg.get("mlp_ratio", 4),
                num_mlp_layers=cfg.get("n_layers", 3),
