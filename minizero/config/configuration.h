...
extern float env_modern_tetris_reward_tspin_single_bonus;
extern float env_modern_tetris_reward_tspin_double_bonus;
extern float env_modern_tetris_reward_tspin_triple_bonus;
extern float env_modern_tetris_reward_tspin_mini_single_bonus;
extern float env_modern_tetris_reward_tspin_mini_double_bonus;
extern float env_modern_tetris_reward_all_spin_bonus;
