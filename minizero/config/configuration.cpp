...
float env_modern_tetris_reward_tspin_single_bonus = 0.0f;
float env_modern_tetris_reward_tspin_double_bonus = 0.0f;
float env_modern_tetris_reward_tspin_triple_bonus = 0.0f;
float env_modern_tetris_reward_tspin_mini_single_bonus = 0.0f;
float env_modern_tetris_reward_tspin_mini_double_bonus = 0.0f;
...
#define MODERNTETRIS_CONFIG_REGISTRATION 1
    ...
    cl.addParameter("env_modern_tetris_reward_tspin_single_bonus", env_modern_tetris_reward_tspin_single_bonus, "reward shaping: extra bonus on a T-spin single (full T-spin clearing 1 line)", "Environment");
    cl.addParameter("env_modern_tetris_reward_tspin_double_bonus", env_modern_tetris_reward_tspin_double_bonus, "reward shaping: extra bonus on a T-spin double (full T-spin clearing 2 lines)", "Environment");
    cl.addParameter("env_modern_tetris_reward_tspin_triple_bonus", env_modern_tetris_reward_tspin_triple_bonus, "reward shaping: extra bonus on a T-spin triple (full T-spin clearing 3 lines)", "Environment");
    cl.addParameter("env_modern_tetris_reward_tspin_mini_single_bonus", env_modern_tetris_reward_tspin_mini_single_bonus, "reward shaping: extra bonus on a T-spin mini single", "Environment");
    cl.addParameter("env_modern_tetris_reward_tspin_mini_double_bonus", env_modern_tetris_reward_tspin_mini_double_bonus, "reward shaping: extra bonus on a T-spin mini double", "Environment");
